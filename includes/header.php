        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">info@automart.com</a> </div>
            <div class="header_widgets">
...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
          ...
          <li><a href="my-testimonials.php">Become a Seller or Renter</a></li>
            <li><a href="logout.php">Sign Out</a></li>
            <?php } else if (($_SESSION['login']) && ($result->type==2)) { ?>
              <li><a href="profile.php">Profile Settings</a></li>
              <li><a href="update-password.php">Update Password</a></li>
            <li><a href="my-vehicles.php">Rented Cars</a></li>
            <li><a href="sold-vehicles.php">Sold Cars</a></li>
            <li><a href="post-testimonial.php">Post a Testimonial</a></li>
          <li><a href="my-testimonials.php">My Testimonial</a></li>
            <li><a href="logout.php">Sign Out</a></li>
              <?php }  else { ?>
            ...
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">My Orders</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="car-listing.php">Rent Cars</a>
          <li><a href="car-sales.php">Buy Cars</a>
