...
<div class="">
    ...
    <button type="image" class="paypal" name="" alt="">Pay Now </button>
...
<script>
	$('.paypal').click(function(){
          swal({
            ...
            text: 'You are about to pay, Click Okay to continue',
            type: 'info',
			...
			setTimeout(function(){ window.location = "my-order.php"; },4000);
          });
        });
	</script>
</body>
