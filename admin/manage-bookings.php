...
$sqls = "UPDATE tblvehicles SET avail=:avail WHERE  id=:vid";
$query = $dbh->prepare($sql);
$querys = $dbh->prepare($sqls);
$query -> bindParam(':status',$status, PDO::PARAM_STR);
$query-> bindParam(':aeid',$aeid, PDO::PARAM_STR);
$querys -> bindParam(':avail',$avail, PDO::PARAM_STR);
$querys -> bindParam(':vid',$vid, PDO::PARAM_STR);
$query -> execute();
$querys -> execute();
...
echo htmlentities('Confirmed');
 	...
 	echo htmlentities('Cancelled');
										...
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>&vid=<?php echo htmlentities($result->vid);?>" onclick="return confirm('Do you really want to Confirm this booking')"> Confirm</a> /
