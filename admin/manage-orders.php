...
$msg="Car Successfully Delivered";
}
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					...
					$query = mysqli_query($conn, "SELECT * FROM transactions LEFT JOIN tblusers ON tblusers.EmailId = transactions.customerid") or die(mysqli_error());
					$cnt=1;
